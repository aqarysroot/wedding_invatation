...
import {sendForm} from "@/api/form.ts";
import i18n from "@/i18n";
import {useParams} from "react-router";

const Home = () => {
    const { z } = useParams<{ z: string }>();
    ...
    return (
        <>
            ...
            {!z ? <section className={styles["main"]}>
            ...
            </section> : <section className={styles["main__z"]}>
                <h1 className={styles["main__title"]}>
                    Arnur <br/> & <br/> Zhanerke
                </h1>
            ...
            <section className={styles["owners"]}>
                ...
                <h2 style={{
                    marginTop: '-35px'
                }} className={styles["owners__names"]}>{!z ? 'Роман - Гульмира' : 'ата-аналары'}</h2>
